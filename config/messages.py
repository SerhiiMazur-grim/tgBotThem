...
MESSAGE_ADMIN_INPUT_THEME_CATEGORY = 'Введите название категории:'
MESSAGE_ADMIN_INPUT_THEME_CATEGORY_ERR = 'Это не подходит для названия категории!\nВведите корректное название категории:'
MESSAGE_ADMIN_INPUT_THEME_CATEGORY_DONE = 'Категорию добавлено в список категорий для тем!'
MESSAGE_ADMIN_ADD_THEME_CATEGORY_ERR = 'Такая тема уже существует в каталоге !!!'
IKB_BUTTON_ADMIN_DEL_THEME_CATEGORY = 'Удалить категорию'
MESSAGE_CHOICE_THEME_CAT_TO_DELETE = 'Выберите категорию для удаления:'
MESSAGE_THEME_CAT_IS_DELETE = 'Категория удалена!'
MESSAGE_THEME_CAT_DELETE_ERR = 'Ошибка при удалении! Детали смотрите в логах!'
MESSAGE_ADD_THEME_TO_CATALOG_ERR = 'Ошибка при добавлении темы в каталог! Детали смотрите в логах!'

BUTTON_ADMIN_LANGUAGE_CATALOG = 'Каталог языков'
