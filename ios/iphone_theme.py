    ...
    async with TelegramClient('annon', api_id, api_hash) as client:
        ...
        if result:
            ...
            ios_data = [
                ...
                f"          stroke: {bg}",
                f"      primaryText: {primary_txt}",
                f"      secondaryText: a5{secondary_txt}",
                ...
                f"    mediaDateAndStatusBg: 7f{darker_bg}",
                f"    mediaDateAndStatusText: {secondary_txt}",
                f"    shareButtonBg:",
                f"      withWp: 66{darker_bg}",
                f"      withoutWp: cc{darker_bg}",
                f"    shareButtonStroke:",
                ...
                f"        scam: ff3b30",
                f"        dateFillStatic: cc{secondary_txt}",
                f"        dateFillFloat: cc{secondary_txt}",
                f"      withCustomWp:",
                f"        bg: 66{bg}",
                f"        primaryText: {primary_txt}",
                f"        linkHighlight: 3f{not_primary_txt}",
                f"        scam: ff3b30",
                f"        dateFillStatic: 66{secondary_txt}",
                f"        dateFillFloat: 44{secondary_txt}",
                f"    unreadBarBg: {darker_bg}",
                f"    unreadBarStroke: {darker_bg}",
                f"    unreadBarText: {not_primary_txt}",
                f"    dateText:",
                f"      withWp: {secondary_txt}",
